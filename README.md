# AI 드론을 활용한 매장관리 프로젝트 - 여기비었드론
여기비었드론 프로젝트는 ICT 멘토링 엑스포 2022 한이음 공모전 출품작(입선)으로 Object Detect 기능을 탑재한 드론이 매장을 자율 주행하며 
매대에 비어있는 상품이 발생하면 모바일 App에 알람을 주어 직원이 비어있는 상품 위치를 할 수 있게 해주는 시스템입니다.
사람과, 진열대를 피해 완전 자율 주행을 하며, 매장의 진열대를 촬영하여 비어있는 상품을 찾아내는 정확도를 높이는 데 초점을 두어 프로젝트를 진행했습니다.
